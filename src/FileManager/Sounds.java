...
public class Sounds {
    ...
    public static final int TITLE_SCREEN = 0, LEVEL_START = 1, STAGE_THEME = 2, FIND_THE_DOOR = 3, GAME_OVER = 4, INVINCIBILITY_THEME = 5, JUST_DIED = 6, ENDING_THEME = 7, LEVEL_COMPLETE = 8, BONUS_STAGE = 9, BOMB_PLANT = 10, EXPLOSION_1 = 11, EXPLOSION_2 = 12, KICK = 13, POWER_UP = 14, DEATH = 15, LEFT = 16, RIGHT = 17, UP = 18, DOWN = 19;
    ...
    private Clip getClip(int i) {
        ...
        else if (i == POWER_UP) path = location.POWER_UP;
